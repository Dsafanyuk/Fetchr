        ...
        <div class="col-lg-6">
          ...
          <v-tabs height="80px" centered light icons-and-text show-arrows>
            ...
            <v-tab-item v-for="i in 2" :key="i" :value="'baby' + i">
              <CourierAcceptedOrders v-if="i == 1" :orders="acceptedOrders" v-on:delivered="getAcceptedOrders"></CourierAcceptedOrders>
              <CourierAcceptedOrders v-if="i == 2" :orders="deliveredOrders"></CourierAcceptedOrders>
            </v-tab-item>
          </v-tabs>
        </div>
      </div>
        ...
        api
          ...
          .then(response => {
            ...
            for (let i = 5; i > aCounter % 5; i--) {
              this.acceptedOrders.push(this.blackOrder);
            }
            for (let i = 5; i > dCounter % 5; i--) {
              this.deliveredOrders.push(this.blackOrder);
            }
        ...
        api
          ...
          .then(response => {
            ...
            for (let i = 5; i > counter % 5; i--) {
              this.orders.push(this.blackOrder);
            }
